	...
	<div class="take">
		<div class="process">
			<el-breadcrumb separator-class="el-icon-minus">
				...
				<el-breadcrumb-item :to="{ path: '/finance/giveOrder' }">配送订单</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<!-- 内容 -->
			...
			<div class="status_nav">
				...
				<div class="search">
					<div class="search_input">
						<input type="text" name="" placeholder="订单编号/药企/门店" maxlength="20" v-model="search">
			...
			<div class="take_lists">
				...
				<div class="info_lists info_list">
					<ul class="list_head" v-for="(item,index) in data">
						...
						{{item.suppliersName}}</li>
						<li :title="item.gmtPayment">
							{{item.gmtPayment}}     
						</li>
					</ul>
				</div>
